...
const Header = () => {
  ...
  console.log("Header component userName:", userName);
  ...
  return (
    <div className="header">
      ...
      <div className="header-items mr-5">
        <ul>
          {/* <li>{data.timer}</li> */}
          <li>{isOnline ? "\u2705" : "🔴"}</li>
          <li>
          ...
          <li className="login-container">
            ...
            {token ? (
              <button
                className="flex whitespace-nowrap hover:text-orange-600  pr-10"
                onClick={() => {
                  logout();
                }}
              >
                <span className="rounded-full bg-sky-800 text-white px-2 py-0.5 text-sm font-medium mt-2 mr-5 hover:bg-sky-600 transition duration-300 cursor-pointer">
                  logout
                </span>
                <span className="w-6 h-6 mt-2 bg-sky-800 text-white rounded-full px-2 py-0.5 text-sm hover:ring-gray-300 hover:ring-4 cursor-pointer">
                  {user}
                </span>
              </button>
            ) : (
              ...
              >
                <svg
                  className="mt-3 mr-3 hover:fill-orange-600"
                  viewBox="6 0 12 24"
                  height="19"
                  width="18"
                  fill="#686b78"
            ...
            <SignInPan panState={state.isPaneOpen} SetpanState={setState} />
            {/* </Link> */}
          </li>
        </ul>
      </div>
